...
__all__ = ['satisfies_requirement', 'satisfies_vr', 'site_only', 'site_acceptance', 'generic_test',
           'system', 'aqf_requirements', 'aqf_vr', 'intrusive', 'slow', 'quick_test',
...
def quick_test(*args):
    """Tag the test method or object as a quick tests.
    ...
    This decorator can be assigned by @quick or @quick()

    :return: Function.

    """
    return grand_decorator('quick', *args)
